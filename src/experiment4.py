...
def main(dataset="concept-MNIST"):
    ...
    if dataset == "concept-MNIST":
        for i in range(config['max_num_of_new_concepts']):
            ...
            torch.save(sequential_model.state_dict(), rf"../models/Experiment 4/Trained on normal data/sequential_model_{i}.pt")
            torch.save(joint_model.state_dict(), rf"../models/Experiment 4/Trained on normal data/joint_model_{i}.pt")
            torch.save(cnn_model.state_dict(), rf"../models/Experiment 4/Trained on normal data/cnn_model_{i}.pt")
            ...
            torch.save(robust_sequential_model.state_dict(), rf"../models/Adversarially trained models/robust_sequential_model_{i}.pt")
            torch.save(robust_joint_model.state_dict(), rf"../models/Adversarially trained models/robust_joint_model_{i}.pt")
            torch.save(robust_cnn_model.state_dict(), rf"../models/Adversarially trained models/robust_cnn_model_{i}.pt")
